...
exports.sortCommentTree =
	exports.traverseCommentTree =
	exports.checkAssociation =
	exports.checkMedia =
	exports.getUsername =
	exports.removeUrls =
	exports.addUrls =
	exports.formatNostrData =
	exports.formatNostrText =
	exports.formatMessagingData =
	exports.formatMessagingText =
	exports.checkGqlCursor =
	exports.splitArray =
	exports.stripSearch =
	exports.unquoteJsonKeys =
	exports.checkNullValues =
	exports.getJSONStorage =
	exports.getTagValue =
	exports.formatTitle =
	exports.formatDate =
	...
	exports.formatFloat =
	exports.formatCount =
	exports.formatDataSize =
	exports.formatAddress =
	exports.formatArtifactType =
	exports.getHashUrl =
		void 0;
...
function getUsername(data) {
	if (data && data.user) {
		...
		else return config_1.STORAGE.none;
	} else {
		return config_1.STORAGE.none;
	}
}
...
function checkAssociation(tags) {
	return (
		getTagValue(tags, config_1.TAGS.keys.associationId) !== '' &&
		getTagValue(tags, config_1.TAGS.keys.associationId) !== config_1.STORAGE.none
	);
}
