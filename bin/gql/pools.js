...
exports.getPoolCount =
	exports.getPoolSearchIndexById =
	exports.getLatestPoolSearchIndexTxId =
	exports.getPoolById =
	exports.getPoolIds =
	exports.getPools =
		void 0;
...
async function getPools() {
	...
	const contract = arClient.warp.contract(config_1.POOL_INDEX_CONTRACT_ID).setEvaluationOptions({ allowBigInt: true });
...
async function getLatestPoolSearchIndexTxId(poolId) {
	...
	for (let i = 1; i < poolSearchIndeces.data.length; i++) {
		...
		let latestIndexDate =
			latestIndexDateTag && latestIndexDateTag !== config_1.STORAGE.none ? parseInt(latestIndexDateTag) : 0;
